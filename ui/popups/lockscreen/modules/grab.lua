...
local reset = function(f, arc, empty)
  arc.value = empty and 0 or 100
  arc.colors = { (not f and Beautiful.lockscreen_passbox_bg_error) or Beautiful.green[300] }
end
...
local function grab(args)
  ...
  function grabber:reset_arc()
    reset(false, arc, true)
  end
