...
return {
  ...
  background = Beautiful.neutral[900],
  icon_size = 48,
  ...
  app_normal_color = Beautiful.neutral[900],
  app_normal_hover_color = Beautiful.neutral[800],
  app_selected_color = Beautiful.primary[500],
  app_selected_hover_color = Beautiful.primary[700],
  app_name_selected_color = Beautiful.neutral[900],
  app_name_normal_color = Beautiful.neutral[100] .. "6F",
  ...
  prompt_color = Beautiful.neutral[850],
