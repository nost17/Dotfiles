...
local info_panel = Awful.popup({
   ...
   placement = function(d)
      Awful.placement.top_right(d, {
         honor_workarea = true,
         margins = Beautiful.useless_gap * 2 + Beautiful.border_width,
      })
   end,
   widget = {
...
awesome.connect_signal("widgets::calendar", function(action)
   ...
   awesome.emit_signal("visible::calendar", info_panel.visible)
end)
