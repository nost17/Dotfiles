...
local function wb_label(item, _, textbox)
    ...
    local bg, fg, shape, shape_bw, shape_bc, icon_color
    ...
    if selected then
        ...
        icon_color = item.style.icon_color_selected or
            beautiful.layoutlist_icon_color_selected
    else
        ...
        icon_color = item.style.icon_color or
    ...
    return text, bg, nil, gcolor.recolor_image(item.icon, icon_color or fg), {
        shape               = shape,
