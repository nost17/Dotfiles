...
function message:set_notification(notif)
  ...
  markup(self, notif.message, notif.fg, Beautiful.notification_font_message)
  ...
  function tb._private.title_changed_callback()
    ...
    if n then
      ...
      markup(
        tb,
        n.message,
        color_lib.LDColor(User.config.dark_mode and "darken" or "lighten", 0.12, Beautiful.notification_fg),
