...
--- Returns a new text normal button
---@class Button
---@param args args
---@return Button
function text_button.normal(args)
   ---@class args
   ---@field fg_normal? string normal foreground color
   ---@field fg_hover? string normal foreground color
   ---@field fg_press? string normal foreground color
   args = args or {}

   args.fg_normal = args.fg_normal or Beautiful.neutral[100]
   args.fg_hover = args.fg_hover or Beautiful.neutral[200]
   args.fg_press = args.fg_press or args.fg_hover
